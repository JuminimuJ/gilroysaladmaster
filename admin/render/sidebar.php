<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar" style="background-image: linear-gradient(to right, #1c8eff , #3096fc);">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="page_home.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="page_products.php">
                    <i class="fas fa-fw fa-boxes"></i>
                    <span>Products</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="page_services.php">
                    <i class="fas fa-fw fa-concierge-bell"></i>
                    <span>Services</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="page_blog.php">
                    <i class="fas fa-fw fa-blog"></i>
                    <span>Blog</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="page_recipe.php">
